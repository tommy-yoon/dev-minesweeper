...
function initSounds() {
  ...
  document.getElementById("boomSound").pause();
  ...
  document.getElementById("resetSound").pause();
  document.getElementById("resetSound").currentTime = 0;
}
...
function initBoard () {
  ...
  resetBoard(boardNode)
  drawBoard(boardNode)
  addListeners(boardNode)
  return true
}

function resetBoard(boardNode) {
